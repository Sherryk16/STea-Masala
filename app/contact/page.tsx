...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("https://formsubmit.co/ajax/steamasala@gmail.com", {
        method: "POST",
        headers: { "Content-Type": "application/json", "Accept": "application/json" },
        body: JSON.stringify({ _subject: "New Inquiry from Stea Masala Website", ...data }),
      });
              ...
              <AnimatePresence mode="wait">
                {formStatus === "success" ? (
                  ...
                  >
                    ...
                    <p className="text-[#1F140D]/70 text-sm sm:text-base xl:text-sm">Thank you for reaching out. We'll get back to you shortly.</p>
                  </motion.div>
                ) : formStatus === "error" ? (
                  <motion.div
                    key="error"
                  ...
                  >
                    ...
                    <p className="text-[#1F140D]/70 mb-4 xl:mb-3 text-sm sm:text-base xl:text-sm">Please try again or contact us via WhatsApp.</p>
